...
const services = [
  ...
  { n: "03", t: "Contract-to-Hire (C2H)", tag: "The Performance-First Framework", accent: "", d: "Evaluate a candidate's technical proficiency and cultural fit in a real-world environment before making a long-term commitment. Effective recruitment for companies who prefer to select candidates on the basis of first-hand experience.", tags: ["Try-before-hire", "Cultural fit", "Real-world"] },
  { n: "05", t: "Executive Search & Board Advisory", tag: "Discretion-Led Identification", accent: "", d: "CXO and Board-level talent, sourced with absolute discretion. Our network extends beyond core senior software professionals to functions like Finance and HR. We hold a proven track record of placing board-level executives in the most reputed multinationals — especially within the Global IT ecosystem.", tags: ["CXO", "Board-level", "Finance & HR"] },
];
        ...
        <div className="wrap">
          <div className="sd-grid">
            <div className="sd-text">
              ...
              <p className="sd-body">A trusted partner to the Big 4 (PWC, Deloitte, KPMG, EY), QCI (Quality Council of India) and ICC (Indian Chamber of Commerce), Arminus deploys specialized manpower for critical public sector projects. Over 200 professionals on our payroll work across national programs in 10+ Indian states.</p>
